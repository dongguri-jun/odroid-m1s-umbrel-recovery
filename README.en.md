...
- App data stored under `/mnt/fullnode` (`/data` is used as an alias to the same location for Umbrel Files compatibility)
- Basic Files folders and app data folders
