...
assert_contains "$tracker_text" 'Working version: `0.5.2`' 'Tracker should reflect VERSION'
...
# shellcheck disable=SC2016
assert_contains "$tracker_text" '- `VERSION`: working version is now `0.5.2-test`.' 'Config include should still keep VERSION status'
# shellcheck disable=SC2016
