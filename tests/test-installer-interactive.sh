...
assert_hashed_shutdown_patch 'public v0.5.31 status-only 30s branch' "$public_region"
...
assert_contains "$state_text" '"version": "0.5.31"' "Success state must declare the managed 0.5.31 version"
