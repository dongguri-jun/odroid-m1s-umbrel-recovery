...
FIXTURE_ROWS=(
  "0.1.0|heuristic:docker-inspect|umbrel=running;data=mounted;docker_socket=/var/run/docker.sock|0.1.0_to_0.2.0|0.5.31_to_0.5.32|$PLAN_0_1_0|missing-umbrel-container-refuses-before-migration"
  "0.2.0|heuristic:mount-guard|umbrel=running;data=mounted;docker_socket=/var/run/docker.sock|0.2.0_to_0.3.0|0.5.31_to_0.5.32|$PLAN_0_2_0|missing-data-identity-refuses-before-migration"
  "0.5.15|installed.json:applied-steps-inference|umbrel=running;data=mounted;docker_socket=/var/run/docker.sock|0.5.15_to_0.5.16|0.5.31_to_0.5.32|$PLAN_0_5_15|malformed-install-state-refuses-before-migration"
  "0.5.17|installed.json:host_version|umbrel=running;data=mounted;data_alias=canonical;docker_socket=/var/run/docker.sock|0.5.17_to_0.5.18|0.5.31_to_0.5.32|$PLAN_0_5_17|unsafe-data-alias-refuses-before-migration"
  "0.5.24|installed.json:version|umbrel=running;data=mounted;system_containers=ready;docker_socket=/var/run/docker.sock|0.5.24_to_0.5.25|0.5.31_to_0.5.32|$PLAN_0_5_24|candidate-postcheck-failure-refuses-final-publication"
  "0.5.26|installed.json:host_version|umbrel=running;data=mounted;safe_shutdown=canonical;docker_socket=/var/run/docker.sock|0.5.26_to_0.5.27|0.5.31_to_0.5.32|$PLAN_0_5_26|safe-shutdown-install-failure-refuses-step-completion"
)
...
matrix_validate_fixture() {
  ...
  matrix_assert_eq "0.5.31_to_0.5.32" "$expected_last" "$fixture_name targets the current final migration"
