...
if not re.search(r'^##\s+0\.5\.32\b', text, flags=re.M):
    raise SystemExit('CHANGELOG.md is missing section: ## 0.5.32')
print('[unit][PASS] changelog includes both the unreleased 0.5.27 transition and the 0.5.32 release section')
PY
